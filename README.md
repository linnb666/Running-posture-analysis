...
本项目是一个面向本科毕业设计场景实现的跑步动作分析工程，目标是基于视频完成姿态估计、运动学分析、质量评分与报告生成。仓库同时保留了原始分析引擎，以及重构后的 Flask + Vue 3 Web 平台，适合用于课程设计、论文支撑、功能演示和后续二次开发。
...
如果你需要把本项目用于论文说明、系统介绍或后续重构，优先参考以下文档：
