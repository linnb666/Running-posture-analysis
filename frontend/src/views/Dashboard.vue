    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <div class="stat-content">
          ...
          <span class="stat-sub">完成率 {{ completionRate }}%</span>
        </div>
      </div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-content stat-content-split">
          <span class="stat-label">视角分布</span>
          <div class="stat-split">
            <div class="split-item">
              <span class="split-name">正面</span>
              <span class="split-value">{{ frontCount }}</span>
            </div>
            <div class="split-item">
              <span class="split-name">侧面</span>
              <span class="split-value">{{ sideCount }}</span>
            </div>
          </div>
          <span class="stat-sub">共 {{ frontCount + sideCount }} 次</span>
        </div>
      </div>
    </div>
...
const frontCount = computed(() => Number(statistics.value?.view_type_counts?.front || 0))
const sideCount = computed(() => Number(statistics.value?.view_type_counts?.side || 0))
const completionRate = computed(() => {
  const total = Number(statistics.value?.total_analyses || 0)
  const completed = Number(statistics.value?.completed_analyses || 0)
  if (!total) return 0
